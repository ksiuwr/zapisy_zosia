...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ZosiaDefinition.registration_limit'
        db.add_column(u'common_zosiadefinition', 'registration_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=180),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ZosiaDefinition.registration_limit'
        db.delete_column(u'common_zosiadefinition', 'registration_limit')
    ...
    models = {
        u'common.zosiadefinition': {
            ...
            'registration_limit': ('django.db.models.fields.IntegerField', [], {'default': '180'}),
